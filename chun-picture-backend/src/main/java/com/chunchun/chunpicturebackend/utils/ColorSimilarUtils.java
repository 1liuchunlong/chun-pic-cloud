package com.chunchun.chunpicturebackend.utils;
...
public class ColorSimilarUtils {
    ...
    public static double calculateSimilarity(Color color1, Color color2) {
        ...
        // 计算欧氏距离
        double distance = Math.sqrt(Math.pow(r1 - r2, 2) + Math.pow(g1 - g2,
                2) + Math.pow(b1 - b2, 2));
     ...
     * @return 相似度（0到1之间，1为完全相同）
     */
    public static double calculateSimilarity(String hexColor1,
                                             String hexColor2) {
