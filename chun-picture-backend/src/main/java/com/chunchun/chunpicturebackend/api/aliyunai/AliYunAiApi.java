package com.chunchun.chunpicturebackend.api.aliyunai;
...
public class AliYunAiApi {
    ...
    // 创建任务地址
    public static final String CREATE_OUT_PAINTING_TASK_URL = "https" +
            "://dashscope.aliyuncs.com/api/v1/services/aigc/image2image/out" +
            "-painting";

    // 查询任务状态
    public static final String GET_OUT_PAINTING_TASK_URL = "https://dashscope" +
            ".aliyuncs.com/api/v1/tasks/%s";
    ...
    public CreateOutPaintingTaskResponse createOutPaintingTask(CreateOutPaintingTaskRequest createOutPaintingTaskRequest) {
        ...
        try (HttpResponse httpResponse = httpRequest.execute()) {
            if (!httpResponse.isOk()) {
                ...
                throw new BusinessException(ErrorCode.OPERATION_ERROR, "AI " +
                        "扩图失败");
            }
    ...
    public GetOutPaintingTaskResponse getOutPaintingTask(String taskId) {
        if (StrUtil.isBlank(taskId)) {
            throw new BusinessException(ErrorCode.OPERATION_ERROR, "任务 ID " +
                    "不能为空");
        }
        // 处理响应
