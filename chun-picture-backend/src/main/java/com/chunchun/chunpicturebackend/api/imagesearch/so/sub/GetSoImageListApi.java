package com.chunchun.chunpicturebackend.api.imagesearch.so.sub;
...
public class GetSoImageListApi {
     ...
     * @return 图片列表对象
     */
    public static List<SoImageSearchResult> getImageList(String imageUrl,
                                                         Integer start) {
        ...
        List<SoImageSearchResult> result = data.getBeanList("result",
                SoImageSearchResult.class);
    ...
    public static void main(String[] args) {
        List<SoImageSearchResult> imageList = getImageList("http://p0.so" +
                ".qhimg.com/t0257d29c212fceba5e.jpg", 0);
