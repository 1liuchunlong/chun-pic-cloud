...
public class GetSoImageUrlApi {
    public static String getSoImageUrl(String imageUrl) {
        String url =
                "https://st.so.com/r?src=st&srcsp=home&img_url=" + imageUrl + "&submittype=imgurl";
        try {
    ...
    public static void main(String[] args) {
        String imageUrl = "https://baolong-picture-1259638363.cos.ap-shanghai" +
                ".myqcloud.com//public/10000000/2025-02-15_ILJxljPdt9Kv1EM1.";
