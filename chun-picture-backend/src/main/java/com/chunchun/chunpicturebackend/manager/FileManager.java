package com.chunchun.chunpicturebackend.manager;
...
import com.chunchun.chunpicturebackend.config.CosClientConfig;
 ...
 * 文件服务
 *
 * @deprecated 已废弃 改为使用upload 包的模版方法优化
 */
@Slf4j
@Service
@Deprecated
...
public class FileManager {
    ...
    public UploadPictureResult uploadPicture(MultipartFile multipartFile,
        ...
        try {
            ...
            double picScale =
                    NumberUtil.round(picWidth * 1.0 / picHeight, 2).doubleValue();
     ...
     * @return
     */
    public UploadPictureResult uploadPicture(String fileUrl,
                                             String uploadPathPrefix) {
        // 校验图片 todo
    ...
    public void validPicture(MultipartFile multipartFile) {
        ...
        ThrowUtils.throwIf(fileSize > 10 * ONE_M, ErrorCode.PARAMS_ERROR,
                "文件大小不能超过 2M");
        // 2. 校验文件后缀
        String fileSuffix =
    ...
    private void validPicture(String fileUrl) {
        ...
        try {
            ...
            if (StrUtil.isNotBlank(contentType)) {
                // 允许的图片类型
                final List<String> ALLOW_CONTENT_TYPES = Arrays.asList("image" +
                                "/jpeg", "image/jpg",
