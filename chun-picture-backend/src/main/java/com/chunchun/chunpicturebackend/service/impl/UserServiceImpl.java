...
import com.chunchun.chunpicturebackend.mapper.UserMapper;
...
import com.chunchun.chunpicturebackend.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(currentUser.getId() == null || currentUser == null,
    ...
    public QueryWrapper<User> getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        // 拼接成sql
        // eq(condition, column, value) 只有当 condition 为 true 时，才会拼 AND column
        // = value
        QueryWrapper<User> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq(ObjUtil.isNotNull(id), "id", id);
        queryWrapper.eq(StrUtil.isNotBlank(userRole), "userRole", userRole);
        queryWrapper.like(StrUtil.isNotBlank(userAccount), "userAccount",
                userAccount);
        queryWrapper.like(StrUtil.isNotBlank(userName), "userName", userName);
        queryWrapper.like(StrUtil.isNotBlank(userProfile), "userProfile",
                userProfile);
